...
public class ChunkPacketCacheService {
    ...
    private final ConcurrentHashMap<ChunkKey, Set<UUID>> realPlayersByChunk = new ConcurrentHashMap<>();
    ...
    public void put(UUID worldId, int chunkX, int chunkZ, ClientboundLevelChunkWithLightPacket packet) {
